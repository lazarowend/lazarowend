# 💫 Sobre mim:
Desenvolvedor Web apaixonado por tecnologia!, iniciei os estudos no inicio de 2022 com um curso técnico de Desenvolvimento de Sistemas pela Unimontes.

Gosto muito de música, séries e filmes, tambem sou apaixonado por hardware e pelo mundo de games

**Atualmente:** 
Atualmente estou para terminar o curso técnico de Desenvolvimento de Sistemas com previsão para 11/23.

**Estudando:** 
No curso técnico estei Redes, HTML, CSS, Bootstrap-5, estou estudando atualmente Javascript, Python, SQL e PHP logo mais. Tambem faço um curso a parte pela DankiCode para refinar meus conhecimentos.
